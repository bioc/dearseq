...
More details are provided in this 
[*bioRxiv* preprint 635714](https://www.biorxiv.org/content/10.1101/635714v1).
...
```{r LR_ST_echo, eval=TRUE, echo=TRUE, message=FALSE}
library(dearseq)
...
```{r London_raw, eval=TRUE, echo=TRUE, warning = FALSE, message=FALSE, results='hide'}
library(readxl)
library(edgeR)
GEOquery::getGEOSuppFiles('GSE107991', 
...
effectively controls the false discovery rate. *bioRxiv* 635714. [DOI: 10.1101/635714v1](https://www.biorxiv.org/content/10.1101/635714v1).
